...
#define BASE_Info1LedFunc                         6      // 32 Bits, Bit 31-0
#define BASE_Info2LedFunc                        10      // 32 Bits, Bit 31-0
#define BASE_Info3LedFunc                        14      // 32 Bits, Bit 31-0
#define BASE_Timezone                            18      // 5 Bits, Bit 7-3
#define     BASE_TimezoneMask 0xF8
#define     BASE_TimezoneShift 3
#define BASE_CombinedTimeDate                    18      // 1 Bit, Bit 2
#define     BASE_CombinedTimeDateMask 0x04
#define     BASE_CombinedTimeDateShift 2
#define BASE_SummertimeAll                       18      // 2 Bits, Bit 1-0
#define     BASE_SummertimeAllMask 0x03
#define     BASE_SummertimeAllShift 0
#define BASE_InternalTime                        18      // 1 Bit, Bit 0
#define     BASE_InternalTimeMask 0x01
#define     BASE_InternalTimeShift 0
#define BASE_TimezoneCustom                      19      // char*, 63 Byte
...
#define NET_HostAddress                         83      // IP address, 4 Byte
#define NET_SubnetMask                          87      // IP address, 4 Byte
#define NET_GatewayAddress                      91      // IP address, 4 Byte
#define NET_NameserverAddress                   95      // IP address, 4 Byte
#define NET_CustomHostname                      99      // 1 Bit, Bit 7
#define     NET_CustomHostnameMask 0x80
#define     NET_CustomHostnameShift 7
#define NET_StaticIP                            99      // 1 Bit, Bit 6
#define     NET_StaticIPMask 0x40
#define     NET_StaticIPShift 6
#define NET_mDNS                                100      // 1 Bit, Bit 7
#define     NET_mDNSMask 0x80
#define     NET_mDNSShift 7
#define NET_HTTP                                100      // 1 Bit, Bit 6
#define     NET_HTTPMask 0x40
#define     NET_HTTPShift 6
#define NET_NTP                                 100      // 1 Bit, Bit 5
#define     NET_NTPMask 0x20
#define     NET_NTPShift 5
#define NET_OTAUpdate                           100      // 2 Bits, Bit 4-3
#define     NET_OTAUpdateMask 0x18
#define     NET_OTAUpdateShift 3
#define NET_HostName                            101      // char*, 24 Byte
#define NET_LanMode                             142      // 4 Bits, Bit 7-4
#define     NET_LanModeMask 0xF0
#define     NET_LanModeShift 4
#define NET_NTPServer                           143      // char*, 50 Byte
...
#define BASE_KommentarModuleParamOffset 194
